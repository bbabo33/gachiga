...
<div align="center">
	...
	<form name="wForm" method="post" action="/carpool/board/add_board.do">
		<table class="post_table">
			...
			<tr>
				<th width="23%">글쓴이</th>
				<td class="L"><span>${ login_result.id}</span> 
				<input type="hidden" name="id" value="${ login_result.id }"></td>
			</tr>
			<tr>
				<th width="23%">내용</th>
				<td><textarea rows="7" cols="20" name="content"	style="width: 100%;"></textarea></td>
			</tr>
		</table>
